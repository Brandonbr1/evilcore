...
public class GuiRepairUnlocker extends GuiContainer implements ICrafting {

    private static final ResourceLocation field_147093_u = new ResourceLocation("textures/gui/container/anvil.png");
    private ContainerRepairUnlocker field_147092_v;
    private GuiTextField field_147091_w;
    private InventoryPlayer field_147094_x;

    public GuiRepairUnlocker(InventoryPlayer p_i1073_1_, World p_i1073_2_, int p_i1073_3_, int p_i1073_4_, int p_i1073_5_)
    {
        super(new ContainerRepairUnlocker(p_i1073_1_, p_i1073_2_, p_i1073_3_, p_i1073_4_, p_i1073_5_, Minecraft.getMinecraft().thePlayer));
        this.field_147094_x = p_i1073_1_;
        this.field_147092_v = (ContainerRepairUnlocker)this.inventorySlots;
    }
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
    {
        ...
        if (this.field_147092_v.maximumCost > 0)
        {
            ...
            if (this.field_147092_v.maximumCost >= 900000000 && !this.mc.thePlayer.capabilities.isCreativeMode)
            {
    ...
    public void sendContainerAndContentsToPlayer(Container p_71110_1_, List<ItemStack> p_71110_2_)
    {
